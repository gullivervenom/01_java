    ...
    public static void main(String[] args) {
        ...
        *   5. 가변인자 */
        ...
        /* comment.
            ...
            why? 가변인자의 끝을 알 수 없기 때문
            */
        pt.testVariableLengthParameter("박재민"); // 가변인자는 전달하지 않아도 된다.
        pt.testVariableLengthParameter("박재민", "야구", "볼링", "축구", "여행");
        pt.testVariableLengthParameter("박재민", new String[]{"테니스", "볼링", "축구"});
