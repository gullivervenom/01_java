...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* comment.
        *   생성자란?
        *   우리가 지금까지 클래스명 레퍼런스변수명 = new 클래스명();
        *   이렇게 객체를 만들어왔다.
        *   new 뒤에 클래스명은 사실 생성자(constructor) 라고 불리는 메소드를
        *   호출하는 구문이다.
        *   하지만, 우리는 지금까지 생성자를 만든 적이 없는데
        *   매개변수가 없는 생성자 '()' 는 complier 에 의해 자동으로 추가되기 때문에
        *   우리가 지금까지 작성하지 않고도 사용할 수 있었던 것이다. */
        ...
        *   */
        ...
        UserDTO user2 = new UserDTO("user01", "pass01", "박재민");
        System.out.println("user2 의 초기값 : "  + user2.toString());

        UserDTO user3 = new UserDTO("user02", "pass02", "박재민", LocalDateTime.now());
