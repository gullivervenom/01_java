...
public class UserDTO {
    ...
    private String pwd;
    private String name;
    private LocalDateTime enrollmentDate; // 필드로 다른 클래스 자료형도 사용 가능(회원가입일시)

    /* comment.
    *   생성자의 작성 위치
    *   작성 위치는 클래스 내부에 작성하면 되지만,
    *   통상적으로 필드와 메소드 선언부 사이에 작성하는 것이 암묵적인 관례이다.
    *   */
    ...
    * */
    ...
    /* index. 1. 기본 생성자 */
    public UserDTO() {
        System.out.println("UserDTO 의 기본 생성자 호출됨... ");
    }
...
//    public UserDTO(){}
    ...
    public UserDTO(String id, String pwd, String name, LocalDateTime enrollmentDate) {
        this.id = id;
        this.pwd = pwd;
        this.name = name;
