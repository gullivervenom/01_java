...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   주로 계층간의 데이터를 주고 받을 목적이다. */
        ...
        System.out.println("회원번호 = " + member.getAge());
        System.out.println("회원번호 = " + member.getGender());
        System.out.println("회원번호 = " + member.getHeight());
        System.out.println("회원번호 = " + member.getWeight());
