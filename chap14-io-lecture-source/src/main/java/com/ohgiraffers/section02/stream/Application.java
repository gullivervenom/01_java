...
public class Application {
    public static void main(String[] args) {
        ...
        *   하드디스크 상의 파일이 될 수도 있고 네트워크 상에 존재한느 자원이 될 수도 있다.
        *   따라서 해당하는 데이털르 가져오거나 내보낼 때 가장 먼저 해야 할 일은
        ...
        *   --
        *   그중 InputStream 과 Reader 는 데이터를 읽어오기 위한 스트림
        ...
        *   */
        ...
        try {
            ...
            // read() : 파일에 기록된 값을 순차적으로 읽어오고
            //          더 이상 읽을 데이터가 없으면 -1 값을 반환
            int value;

            // 한글 1 글자는 3byte 기 때문에 1byte 씩 읽어오면
            // 글자가 깨지게 된다.
