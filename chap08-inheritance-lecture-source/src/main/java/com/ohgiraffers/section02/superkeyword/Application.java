...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* title. super 와 super() 에 대해 이해할 수 있다. */
        ...
        *           레퍼런스 변수이다.
        *   super() : 부모 생성자를 호출하는 구문으로 인자와
        *             매개변수의 타입, 갯수, 순서가 일치하는 부모의 생성자를 호출한다.*/

        Product product1 = new Product();
        System.out.println(product1.getInfo());

        Product product2 = new Product("S-01234", "삼성", "갤럭시폴드7",
                2200000, LocalDateTime.now());
        ...
        Computer computer3 = new Computer("S-01234", "삼성", "갤럭시폴드7",
                2200000, LocalDateTime.now(), "인텔", 512, 16, "윈도우");
