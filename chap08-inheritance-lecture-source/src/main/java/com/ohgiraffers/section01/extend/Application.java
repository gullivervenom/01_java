...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *            수정 사항이 생길 시 부모 클래스만 수정을 해도 전체적으로 사용 가능(유지보수성 증가)
        *   2. 클래스 간의 계층 관계가 생기며 다형성 문법의 토대가 된다.
        *
        *  comment.
        *   하지만 상속으로 인한 단점도 존재
        *   1. 부모클래스의 기능을 추가/변경 할 시 자식 클래스가 정상적으로 동작하는 지 예측 어려움.
        *      상속 구조가 복잡해 질수록 그 영향에 대한 예측이 힘들어지며
        *      이러한 복잡한 구조는 오히려 유지보수성을 악화 시킬 수 있다.
        *   2. 또한 부모 클래스의 변경이 쉽지 않다. 자식클래스에서 중요하게 사용하고 있는
        *      부모의 메소드를 수정할 시 자식 클래스에 모두 영향을 미칠 수 있다
        *   3. 부모 클래스에서는 의미 있는 기능이 자식에겐 무의미 할 수 있다. */
...
//        fireCar.isRunning();
        ...
        /* index. 3. 소방차 너무 재미없게 경적을 울린다..
            ...
            */
        /* comment. 상속은 물려받는 것뿐만 아니라 확장도 할 수 있다. */
        fireCar.sprayWater();
