...
public class B_ifElse {
    ...
    /* title. if-else 문 닥독 사용에 대한 흐름을 이해하고 적용할 수 있다. */
    /* comment.
     *   [if-else 문 표현식]
     *   if(조건식){
     ...
     * */
    /* index. 1. 문제
     *   정수 한 개를 입력 받아 그 수가 홀수 이면 "입력하신 숫자는 홀수입니다." 를 출력하고
...
//            } else {
//                System.out.println("입력하신 정수는 양수이며 홀수입니다.");
//            }
//
//
//        }
//        System.out.println("프로그램을 종료합니다.");
    ...
    public void testNestedIfStatement() {
        ...
        *   단, 0 이면 "입력하신 숫자는 0 입니다." 출력
        *   조건과 상관없이 프로그램이 종료될 때 "프로그램을 종료합니다."를
        *   출력하는 프로그램을 만들어보자.
        *
        * */
