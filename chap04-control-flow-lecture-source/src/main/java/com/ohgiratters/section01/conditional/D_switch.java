...
public class D_switch {
    ...
    public void testSwitchStatement() {
        ...
        *       case 비교값2 : 비교값2 와 일치하는 경우 실행구문; break;
        ...
        *   */
        ...
        // 입력한 연산기호 문자에 따라서 연ㅇ산 결과를 다르게 만들어보기
    ...
    public void testSwitchVendingMachine() {
        ...
        switch (selectDrink) {
            case "s" :
                ...
                price = 500;
            case "m" :
                System.out.println("맥콜을 선택하셨습니다.");
                price = 300;
            case "n" :
                System.out.println("눈의솔을 선택하셨습니다.");
                price = 200;
            case "c" :
            ...
            case "h" :
                ...
                price = 600;
            case "k" :
                System.out.println("밀키스를 선택하셨습니다.");
                price = 1000;
