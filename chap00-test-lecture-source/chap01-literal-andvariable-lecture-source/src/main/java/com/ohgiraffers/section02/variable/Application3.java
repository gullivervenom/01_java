...
//        int sh@op = 20;
        ...
        int akljsdhaoshdqaxcmizxmclaksdhajksdhajkshd;
        ...
        *             두 번째 시작 단어는 대문자로 시작한다. */
        ...
        int minAge = 10;
        String user_name = "박재민"; // java 에서는 하지 않는다
        String userName = "박재민"; // 이게 java 에서의 올바른 표기법이다.
       ...
       /* 목차. 2-4. 변수 안에 저장 된 값이 어떤 의미를 가지는 지 명확히 표현하자!! */
        ...
        /* 목차. 2-7. boolean 형들은 의문문으로 가급적이면 긍정 형태로 작성한다. */
//        boolean isDead = true;
