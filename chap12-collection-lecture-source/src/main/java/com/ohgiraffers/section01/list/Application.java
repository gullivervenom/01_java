...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   쉽고 효과적으로 처리할 수 있도록 표준화 된 방법을 제공하는 클래스들의 집합을 의미한다.
...
//        List list = new List();
        ...
        * */
        ...
        // 제네릭 문법으로 타입을 지정하게 되면 지정한 타입 외의 값은 저장할 수 없다.
//        stringList.add(123);
//        stringList.add(453.67);
//        stringList.add(new Date());

        /* comment.
        *   정렬 기능도 사용할 수 있다.
        *   저장 수선를 유지하고 있는 stringList 를 오름차순 정렬
        *   */
...
//        List<String> stringList = new LinkedList<>(stringList);
        ...
        *   없기 때문에 인덱스를 사용하지 않고도 반복문을 사용하기 위한 목록을 만들어주는
        *   역할이라고 보면 된다.
