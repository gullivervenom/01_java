...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* title. Map 의 자료 구조에 대해 이해하고 HashMap 을 이용할 수 있다. */

        /* comment.
        *   Map 인터페이스의 특징
        *   일반적인 Collection 인터페이스와는 다른 저장 방식을 가지고 있다.
        *   Map 의 가장 큰 특징은
        *   키(key) 와 값(value) 을 하나의 세트로 저장하는 방식이다.
        *   */
        ...
        *   */
        ...
        System.out.println(" 12 번 키에 해당하는 값 : " + hmap.get(12));
        ...
        /* index. 2. Iterator 에서 제공하는 hasNext(), next() 메소드를 사용해서 반복문 */
