...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        *   그래서 패키지 명을 생ㄹ약하고 사용할 수 있도록 한 구문이 import 이다.
        ...
        *    */
        ...
        System.out.println("50 과 60 중 더 작은 값은 : " + min);
        /* non-static 메소드 호출*/

        // 출력 예시 : 50 과 60 중 더 작은 값은 : 50


        /* static 메소드 호출*/

        // 출력 예시 : 50 과 60 중 더 큰 값은 : 50
        int max = calc.maxNumberOf(50, 60);
        System.out.println("50 과 60 중 더 큰 값은 : " + max);
