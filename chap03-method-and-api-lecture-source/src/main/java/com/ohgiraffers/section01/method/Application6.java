...
public class Application6 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* comment.
        *   return 값을 반환 받기 위해서는 메소드 선언부에 리턴 타입을 명시해 주서야 한다.
        *   void 는 아무 반환값도 가지지 않겠다는 키워드이고,
        *   return 구문을 생략해도 컴파일러가 자동으로 추가해주지만,
        *   반환값이 있는 경우는 return 구문을 반드시 명시적으로 작성을 해주서야 한다.
        *   또한, 리턴 타입의 반환 값의 자료형은 반!드!시! 일치해야 한다.
        *   - 자바는 자료형이 정말 중요하다.
        * */
        ...
        /* comment.
         *  메소드를 호출했을 때 main 시작과 끝 출력문만 나온다.
         *  그러나 호출은 된 상태이다.
