...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* title. Scanner를 이용해서 값 입력해보기 */

        /* index. 1. Scanner 클래스를 사용 할 준비 */
        Scanner sc = new Scanner(System.in);

        /* comment. ln 의 의미는 개행(줄바꿈)의 의미이다. */

        System.out.println("안녕");
        System.out.print("나는");
        System.out.println("박재민이야");
