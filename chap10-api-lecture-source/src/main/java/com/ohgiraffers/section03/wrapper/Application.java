...
public class Application {
    public static void main(String[] args) {
        ...
        *   이 때 기보 ㄴ타입의 데이터를 먼저 인스턴스로 변환 후
        *   사용해야 하는데 8가지의 기본 타입 데이터를
        *   인스턴스화 할 수 있도록 하는 클래스 Wrapper 클래스 라고 한다.
        ...
        *   기본(원시)타입을 래퍼클래스로 인스턴스화 하는 것을 Boxing 이라고 하고
        *   래퍼클래스로 인스턴스화된 것을 기본 타입으로 변경하는 것을 UnBoxing 이라고 한다.
        * */
        ...
        *   */
        ...
        // 오토 언박싱 : Interger 타입의 boxingNumber3 를 원시타입에 대입
