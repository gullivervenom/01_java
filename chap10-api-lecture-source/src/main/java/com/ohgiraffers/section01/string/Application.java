...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   */
        String trimStr = "   java   ";
        System.out.println("trimStr : @" + trimStr + "@"); // 공백 확인 용
        System.out.println("trim : @" + trimStr.trim() + "@");
        System.out.println("trimStr = " + trimStr); // 역시 원본은 영향을 받지 않는다.

        /* comment.
        *   toLowerCase() : 모든 문자를 소문자로 바꿔 줌
        *   toUpperCase() : 모든 문자를 대문자로 바꿔 줌
        *   */
        ...
        * */
        ...
        System.out.println("substring(3, 6) : " + str4.substring(3, 6)); // 3 <= i <6 aMy
        System.out.println("substring(3) : " + str4.substring(3)); // 3
