...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   - 참과 거짓을 판단해준다.
        *       1-1. &&(논리 AND) 연산자
        *       - 두 개의 논리식 모두 참 일 경우 참을 반환, 둘 중 하나라도 거짓이면 거짓.
        *       1-2. ||(논리 OR) 연산자
        *       - 두 개의 논리식 중 하나라도 참이면 참, 둘 다 거짓이면 거짓.
        *   2. 논리 부정 연산자
        *   - 피연산자가 하나인 단항 연산자
        *       2-1.  !(논리 not) 연산자
        ...
        *       - (식을 반전? 시킨다.) */
        ...
        System.out.println("a가 b보다 작으면서 c가 d보다 큰 지  확인 : " + (a < b && c > d));
        System.out.println("a가 b보다 크면서 c가 d보다 작은지 확인 : " + (a > b && c < d));
        System.out.println("a가 b보다 크면서 c가 d보다 큰 지 확인 : " + (a > b && c > d));
