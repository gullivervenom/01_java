...
public class Application2 {
    public static void main(String[] args) {
        ...
        *   자료형 변수명[] ; */
        ...
        /* index. 2. 할당 */
        /* comment.
            우리가 위에서 선언한 레퍼런스변수에 배열을 할당하여 대입할 수 있다.
...
//        iarr =new int[]; 공간을 지정하지 않으면 오류 발생
        iarr = new int[5];
        carr = new char[10];
        ...
        * */
        ...
        /* comment.
        *   hashcode() : 일반적으로 객체의 주소값을 10 진수 > 우리가 알 수 있는 정수
        ...
        *   그래서 String 의 경우에는 문자열의 길이를 메소드로 제공하기 있기 때문에
        ...
        *   새로운 공간을 할당해서 주소값을 레퍼런스변수에 덮어 쓴 것이다. */
        ...
        darr = new double[10];
        System.out.println("수정 darr 의 hashcode : " + darr.hashCode());
        ...
        *   heap 의 old 영역으로 이동하여 GC(garbage collector)가 삭제를 해준다.
        * */

        /* comment.
         *   NullPointerException
         *   아무것도 참조하지 않고 null 이라는 특수한 값을
         *   참조하고 있는 경우에 참조연산자 (.) 를 사용하게 될 때
         *   발생하는 에러
         *   가장 많이 볼 에러 중 1개이다.
         * */
        darr = null;
