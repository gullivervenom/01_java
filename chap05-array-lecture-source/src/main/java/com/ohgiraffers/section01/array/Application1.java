...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   new : 할당 연산자
        *   배열의 사용 이유
        *   만약 배열을 사용하지 않게 된다면, 필요한 값을 일일이 변수에 담아 주어야 한다.
        *   why? > 변수는 값 1개만을 저장할 수 있기 때문에
        ...
        *   공간마다 찾아갈 수 있는 번호(인덱스)를 이용해서 접근할 수 있다. */
        arr[0] = 10;
        arr[1] = 20;
        arr[2] = 30;
        arr[3] = 40;
        ...
        for(int i = 0, value = 0; i < 5; i++) {
            arr[i] = value = value + 10;
            System.out.println((i+1) + "번 째 까지의 값  = " + arr[i]);
